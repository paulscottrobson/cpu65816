case 0x0a1: ; lda (dir,X) [$a1] A0X0
    EAC_INDEXIND();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0a3: ; lda stk,S  [$a3] A0X0
    EAC_STACKREL();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0a5: ; lda dir    [$a5] A0X0
    EAC_DIRECT();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0a7: ; lda [dir]  [$a7] A0X0
    EAC_DIRFARIND();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0a9: ; lda #imm   [$a9] A0X0
    EAC_IMMDEPEND();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0ad: ; lda abs    [$ad] A0X0
    EAC_ABSOLUTE();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0af: ; lda long   [$af] A0X0
    EAC_FAR();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0b1: ; lda (dir),Y [$b1] A0X0
    EAC_INDINDEXY();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0b2: ; lda (dir)  [$b2] A0X0
    EAC_INDIRECT();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0b3: ; lda (stk,S),Y [$b3] A0X0
    EAC_STACKRELINDINDEX();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0b5: ; lda dir,x  [$b5] A0X0
    EAC_DIRECTX();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0b7: ; lda [dir],y [$b7] A0X0
    EAC_FARINDINDEX();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0b9: ; lda abs,y  [$b9] A0X0
    EAC_ABSY();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0bd: ; lda abs,x  [$bd] A0X0
    EAC_ABSX();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x0bf: ; lda long,x [$bf] A0X0
    EAC_LONGX();cpu.AL = CPUReadByte();ALUSetNZ8(cpu.AL);break;
...
case 0x2a1: ; lda (dir,X) [$a1] A1X0
    EAC_INDEXIND();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2a3: ; lda stk,S  [$a3] A1X0
    EAC_STACKREL();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2a5: ; lda dir    [$a5] A1X0
    EAC_DIRECT();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2a7: ; lda [dir]  [$a7] A1X0
    EAC_DIRFARIND();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2a9: ; lda #imm   [$a9] A1X0
    EAC_IMMDEPEND();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2ad: ; lda abs    [$ad] A1X0
    EAC_ABSOLUTE();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2af: ; lda long   [$af] A1X0
    EAC_FAR();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2b1: ; lda (dir),Y [$b1] A1X0
    EAC_INDINDEXY();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2b2: ; lda (dir)  [$b2] A1X0
    EAC_INDIRECT();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2b3: ; lda (stk,S),Y [$b3] A1X0
    EAC_STACKRELINDINDEX();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2b5: ; lda dir,x  [$b5] A1X0
    EAC_DIRECTX();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2b7: ; lda [dir],y [$b7] A1X0
    EAC_FARINDINDEX();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2b9: ; lda abs,y  [$b9] A1X0
    EAC_ABSY();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2bd: ; lda abs,x  [$bd] A1X0
    EAC_ABSX();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x2bf: ; lda long,x [$bf] A1X0
    EAC_LONGX();cpu.A = CPUReadWord();ALUSetNZ16(cpu.A);break;
...
case 0x081: ; sta (dir,X) [$81] A0X0
    EAC_INDEXIND();MB8 = cpu.AL;CPUWriteByte();break;

case 0x083: ; sta stk,S  [$83] A0X0
    EAC_STACKREL();MB8 = cpu.AL;CPUWriteByte();break;

case 0x085: ; sta dir    [$85] A0X0
    EAC_DIRECT();MB8 = cpu.AL;CPUWriteByte();break;

case 0x087: ; sta [dir]  [$87] A0X0
    EAC_DIRFARIND();MB8 = cpu.AL;CPUWriteByte();break;

case 0x08d: ; sta abs    [$8d] A0X0
    EAC_ABSOLUTE();MB8 = cpu.AL;CPUWriteByte();break;

case 0x08f: ; sta long   [$8f] A0X0
    EAC_FAR();MB8 = cpu.AL;CPUWriteByte();break;

case 0x091: ; sta (dir),Y [$91] A0X0
    EAC_INDINDEXY();MB8 = cpu.AL;CPUWriteByte();break;

case 0x092: ; sta (dir)  [$92] A0X0
    EAC_INDIRECT();MB8 = cpu.AL;CPUWriteByte();break;

case 0x093: ; sta (stk,S),Y [$93] A0X0
    EAC_STACKRELINDINDEX();MB8 = cpu.AL;CPUWriteByte();break;

case 0x095: ; sta dir,x  [$95] A0X0
    EAC_DIRECTX();MB8 = cpu.AL;CPUWriteByte();break;

case 0x097: ; sta [dir],y [$97] A0X0
    EAC_FARINDINDEX();MB8 = cpu.AL;CPUWriteByte();break;

case 0x099: ; sta abs,y  [$99] A0X0
    EAC_ABSY();MB8 = cpu.AL;CPUWriteByte();break;

case 0x09d: ; sta abs,x  [$9d] A0X0
    EAC_ABSX();MB8 = cpu.AL;CPUWriteByte();break;

case 0x09f: ; sta long,x [$9f] A0X0
    EAC_LONGX();MB8 = cpu.AL;CPUWriteByte();break;
...
case 0x281: ; sta (dir,X) [$81] A1X0
    EAC_INDEXIND();MB16 = cpu.A;CPUWriteWord();break;

case 0x283: ; sta stk,S  [$83] A1X0
    EAC_STACKREL();MB16 = cpu.A;CPUWriteWord();break;

case 0x285: ; sta dir    [$85] A1X0
    EAC_DIRECT();MB16 = cpu.A;CPUWriteWord();break;

case 0x287: ; sta [dir]  [$87] A1X0
    EAC_DIRFARIND();MB16 = cpu.A;CPUWriteWord();break;

case 0x28d: ; sta abs    [$8d] A1X0
    EAC_ABSOLUTE();MB16 = cpu.A;CPUWriteWord();break;

case 0x28f: ; sta long   [$8f] A1X0
    EAC_FAR();MB16 = cpu.A;CPUWriteWord();break;

case 0x291: ; sta (dir),Y [$91] A1X0
    EAC_INDINDEXY();MB16 = cpu.A;CPUWriteWord();break;

case 0x292: ; sta (dir)  [$92] A1X0
    EAC_INDIRECT();MB16 = cpu.A;CPUWriteWord();break;

case 0x293: ; sta (stk,S),Y [$93] A1X0
    EAC_STACKRELINDINDEX();MB16 = cpu.A;CPUWriteWord();break;

case 0x295: ; sta dir,x  [$95] A1X0
    EAC_DIRECTX();MB16 = cpu.A;CPUWriteWord();break;

case 0x297: ; sta [dir],y [$97] A1X0
    EAC_FARINDINDEX();MB16 = cpu.A;CPUWriteWord();break;

case 0x299: ; sta abs,y  [$99] A1X0
    EAC_ABSY();MB16 = cpu.A;CPUWriteWord();break;

case 0x29d: ; sta abs,x  [$9d] A1X0
    EAC_ABSX();MB16 = cpu.A;CPUWriteWord();break;

case 0x29f: ; sta long,x [$9f] A1X0
    EAC_LONGX();MB16 = cpu.A;CPUWriteWord();break;
...
case 0x061: ; adc (dir,X) [$61] A0X0
    EAC_INDEXIND();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x063: ; adc stk,S  [$63] A0X0
    EAC_STACKREL();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x065: ; adc dir    [$65] A0X0
    EAC_DIRECT();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x067: ; adc [dir]  [$67] A0X0
    EAC_DIRFARIND();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x069: ; adc #imm   [$69] A0X0
    EAC_IMMDEPEND();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x06d: ; adc abs    [$6d] A0X0
    EAC_ABSOLUTE();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x06f: ; adc long   [$6f] A0X0
    EAC_FAR();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x071: ; adc (dir),Y [$71] A0X0
    EAC_INDINDEXY();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x072: ; adc (dir)  [$72] A0X0
    EAC_INDIRECT();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x073: ; adc (stk,S),Y [$73] A0X0
    EAC_STACKRELINDINDEX();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x075: ; adc dir,x  [$75] A0X0
    EAC_DIRECTX();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x077: ; adc [dir],y [$77] A0X0
    EAC_FARINDINDEX();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x079: ; adc abs,y  [$79] A0X0
    EAC_ABSY();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x07d: ; adc abs,x  [$7d] A0X0
    EAC_ABSX();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;

case 0x07f: ; adc long,x [$7f] A0X0
    EAC_LONGX();cpu.AL = ALUAdc8(cpu.AL,CPUReadByte());break;
...
case 0x261: ; adc (dir,X) [$61] A1X0
    EAC_INDEXIND();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x263: ; adc stk,S  [$63] A1X0
    EAC_STACKREL();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x265: ; adc dir    [$65] A1X0
    EAC_DIRECT();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x267: ; adc [dir]  [$67] A1X0
    EAC_DIRFARIND();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x269: ; adc #imm   [$69] A1X0
    EAC_IMMDEPEND();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x26d: ; adc abs    [$6d] A1X0
    EAC_ABSOLUTE();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x26f: ; adc long   [$6f] A1X0
    EAC_FAR();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x271: ; adc (dir),Y [$71] A1X0
    EAC_INDINDEXY();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x272: ; adc (dir)  [$72] A1X0
    EAC_INDIRECT();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x273: ; adc (stk,S),Y [$73] A1X0
    EAC_STACKRELINDINDEX();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x275: ; adc dir,x  [$75] A1X0
    EAC_DIRECTX();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x277: ; adc [dir],y [$77] A1X0
    EAC_FARINDINDEX();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x279: ; adc abs,y  [$79] A1X0
    EAC_ABSY();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x27d: ; adc abs,x  [$7d] A1X0
    EAC_ABSX();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;

case 0x27f: ; adc long,x [$7f] A1X0
    EAC_LONGX();cpu.A = ALUAdc16(cpu.A,CPUReadWord());break;
...
case 0x0e1: ; sbc (dir,X) [$e1] A0X0
    EAC_INDEXIND();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0e3: ; sbc stk,S  [$e3] A0X0
    EAC_STACKREL();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0e5: ; sbc dir    [$e5] A0X0
    EAC_DIRECT();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0e7: ; sbc [dir]  [$e7] A0X0
    EAC_DIRFARIND();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0e9: ; sbc #imm   [$e9] A0X0
    EAC_IMMDEPEND();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0ed: ; sbc abs    [$ed] A0X0
    EAC_ABSOLUTE();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0ef: ; sbc long   [$ef] A0X0
    EAC_FAR();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0f1: ; sbc (dir),Y [$f1] A0X0
    EAC_INDINDEXY();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0f2: ; sbc (dir)  [$f2] A0X0
    EAC_INDIRECT();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0f3: ; sbc (stk,S),Y [$f3] A0X0
    EAC_STACKRELINDINDEX();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0f5: ; sbc dir,x  [$f5] A0X0
    EAC_DIRECTX();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0f7: ; sbc [dir],y [$f7] A0X0
    EAC_FARINDINDEX();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0f9: ; sbc abs,y  [$f9] A0X0
    EAC_ABSY();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0fd: ; sbc abs,x  [$fd] A0X0
    EAC_ABSX();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;

case 0x0ff: ; sbc long,x [$ff] A0X0
    EAC_LONGX();cpu.AL = ALUSbc8(cpu.AL,CPUReadByte(),0);break;
...
case 0x2e1: ; sbc (dir,X) [$e1] A1X0
    EAC_INDEXIND();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2e3: ; sbc stk,S  [$e3] A1X0
    EAC_STACKREL();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2e5: ; sbc dir    [$e5] A1X0
    EAC_DIRECT();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2e7: ; sbc [dir]  [$e7] A1X0
    EAC_DIRFARIND();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2e9: ; sbc #imm   [$e9] A1X0
    EAC_IMMDEPEND();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2ed: ; sbc abs    [$ed] A1X0
    EAC_ABSOLUTE();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2ef: ; sbc long   [$ef] A1X0
    EAC_FAR();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2f1: ; sbc (dir),Y [$f1] A1X0
    EAC_INDINDEXY();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2f2: ; sbc (dir)  [$f2] A1X0
    EAC_INDIRECT();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2f3: ; sbc (stk,S),Y [$f3] A1X0
    EAC_STACKRELINDINDEX();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2f5: ; sbc dir,x  [$f5] A1X0
    EAC_DIRECTX();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2f7: ; sbc [dir],y [$f7] A1X0
    EAC_FARINDINDEX();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2f9: ; sbc abs,y  [$f9] A1X0
    EAC_ABSY();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2fd: ; sbc abs,x  [$fd] A1X0
    EAC_ABSX();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;

case 0x2ff: ; sbc long,x [$ff] A1X0
    EAC_LONGX();cpu.A = ALUSbc16(cpu.A,CPUReadWord(),0);break;
...
case 0x0c1: ; cmp (dir,X) [$c1] A0X0
    EAC_INDEXIND();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0c3: ; cmp stk,S  [$c3] A0X0
    EAC_STACKREL();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0c5: ; cmp dir    [$c5] A0X0
    EAC_DIRECT();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0c7: ; cmp [dir]  [$c7] A0X0
    EAC_DIRFARIND();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0c9: ; cmp #imm   [$c9] A0X0
    EAC_IMMDEPEND();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0cd: ; cmp abs    [$cd] A0X0
    EAC_ABSOLUTE();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0cf: ; cmp long   [$cf] A0X0
    EAC_FAR();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0d1: ; cmp (dir),Y [$d1] A0X0
    EAC_INDINDEXY();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0d2: ; cmp (dir)  [$d2] A0X0
    EAC_INDIRECT();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0d3: ; cmp (stk,S),Y [$d3] A0X0
    EAC_STACKRELINDINDEX();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0d5: ; cmp dir,x  [$d5] A0X0
    EAC_DIRECTX();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0d7: ; cmp [dir],y [$d7] A0X0
    EAC_FARINDINDEX();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0d9: ; cmp abs,y  [$d9] A0X0
    EAC_ABSY();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0dd: ; cmp abs,x  [$dd] A0X0
    EAC_ABSX();ALUSbc8(cpu.AL,CPUReadByte(),1);break;

case 0x0df: ; cmp long,x [$df] A0X0
    EAC_LONGX();ALUSbc8(cpu.AL,CPUReadByte(),1);break;
...
case 0x2c1: ; cmp (dir,X) [$c1] A1X0
    EAC_INDEXIND();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2c3: ; cmp stk,S  [$c3] A1X0
    EAC_STACKREL();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2c5: ; cmp dir    [$c5] A1X0
    EAC_DIRECT();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2c7: ; cmp [dir]  [$c7] A1X0
    EAC_DIRFARIND();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2c9: ; cmp #imm   [$c9] A1X0
    EAC_IMMDEPEND();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2cd: ; cmp abs    [$cd] A1X0
    EAC_ABSOLUTE();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2cf: ; cmp long   [$cf] A1X0
    EAC_FAR();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2d1: ; cmp (dir),Y [$d1] A1X0
    EAC_INDINDEXY();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2d2: ; cmp (dir)  [$d2] A1X0
    EAC_INDIRECT();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2d3: ; cmp (stk,S),Y [$d3] A1X0
    EAC_STACKRELINDINDEX();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2d5: ; cmp dir,x  [$d5] A1X0
    EAC_DIRECTX();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2d7: ; cmp [dir],y [$d7] A1X0
    EAC_FARINDINDEX();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2d9: ; cmp abs,y  [$d9] A1X0
    EAC_ABSY();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2dd: ; cmp abs,x  [$dd] A1X0
    EAC_ABSX();ALUSbc16(cpu.A,CPUReadWord(),1);break;

case 0x2df: ; cmp long,x [$df] A1X0
    EAC_LONGX();ALUSbc16(cpu.A,CPUReadWord(),1);break;
...
case 0x021: ; and (dir,X) [$21] A0X0
    EAC_INDEXIND();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x023: ; and stk,S  [$23] A0X0
    EAC_STACKREL();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x025: ; and dir    [$25] A0X0
    EAC_DIRECT();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x027: ; and [dir]  [$27] A0X0
    EAC_DIRFARIND();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x029: ; and #imm   [$29] A0X0
    EAC_IMMDEPEND();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x02d: ; and abs    [$2d] A0X0
    EAC_ABSOLUTE();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x02f: ; and long   [$2f] A0X0
    EAC_FAR();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x031: ; and (dir),Y [$31] A0X0
    EAC_INDINDEXY();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x032: ; and (dir)  [$32] A0X0
    EAC_INDIRECT();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x033: ; and (stk,S),Y [$33] A0X0
    EAC_STACKRELINDINDEX();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x035: ; and dir,x  [$35] A0X0
    EAC_DIRECTX();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x037: ; and [dir],y [$37] A0X0
    EAC_FARINDINDEX();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x039: ; and abs,y  [$39] A0X0
    EAC_ABSY();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x03d: ; and abs,x  [$3d] A0X0
    EAC_ABSX();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;

case 0x03f: ; and long,x [$3f] A0X0
    EAC_LONGX();cpu.AL = cpu.AL & CPUReadByte();ALUSetNZ8(cpu.AL);break;
...
case 0x221: ; and (dir,X) [$21] A1X0
    EAC_INDEXIND();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x223: ; and stk,S  [$23] A1X0
    EAC_STACKREL();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x225: ; and dir    [$25] A1X0
    EAC_DIRECT();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x227: ; and [dir]  [$27] A1X0
    EAC_DIRFARIND();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x229: ; and #imm   [$29] A1X0
    EAC_IMMDEPEND();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x22d: ; and abs    [$2d] A1X0
    EAC_ABSOLUTE();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x22f: ; and long   [$2f] A1X0
    EAC_FAR();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x231: ; and (dir),Y [$31] A1X0
    EAC_INDINDEXY();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x232: ; and (dir)  [$32] A1X0
    EAC_INDIRECT();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x233: ; and (stk,S),Y [$33] A1X0
    EAC_STACKRELINDINDEX();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x235: ; and dir,x  [$35] A1X0
    EAC_DIRECTX();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x237: ; and [dir],y [$37] A1X0
    EAC_FARINDINDEX();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x239: ; and abs,y  [$39] A1X0
    EAC_ABSY();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x23d: ; and abs,x  [$3d] A1X0
    EAC_ABSX();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;

case 0x23f: ; and long,x [$3f] A1X0
    EAC_LONGX();cpu.A = cpu.A & CPUReadWord();ALUSetNZ16(cpu.A);break;
...
case 0x0a2: ; ldx #imm   [$a2] A0X0
    EAC_IMMDEPEND();cpu.XL = CPUReadByte();ALUSetNZ8(cpu.XL);break;

case 0x0a6: ; ldx dir    [$a6] A0X0
    EAC_DIRECT();cpu.XL = CPUReadByte();ALUSetNZ8(cpu.XL);break;

case 0x0ae: ; ldx abs    [$ae] A0X0
    EAC_ABSOLUTE();cpu.XL = CPUReadByte();ALUSetNZ8(cpu.XL);break;

case 0x0b6: ; ldx dir,Y  [$b6] A0X0
    EAC_DIRY();cpu.XL = CPUReadByte();ALUSetNZ8(cpu.XL);break;

case 0x0be: ; ldx abs,Y  [$be] A0X0
    EAC_ABSY();cpu.XL = CPUReadByte();ALUSetNZ8(cpu.XL);break;
...
case 0x2a2: ; ldx #imm   [$a2] A1X0
    EAC_IMMDEPEND();cpu.X = CPUReadWord();ALUSetNZ16(cpu.X);break;

case 0x2a6: ; ldx dir    [$a6] A1X0
    EAC_DIRECT();cpu.X = CPUReadWord();ALUSetNZ16(cpu.X);break;

case 0x2ae: ; ldx abs    [$ae] A1X0
    EAC_ABSOLUTE();cpu.X = CPUReadWord();ALUSetNZ16(cpu.X);break;

case 0x2b6: ; ldx dir,Y  [$b6] A1X0
    EAC_DIRY();cpu.X = CPUReadWord();ALUSetNZ16(cpu.X);break;

case 0x2be: ; ldx abs,Y  [$be] A1X0
    EAC_ABSY();cpu.X = CPUReadWord();ALUSetNZ16(cpu.X);break;
...
case 0x0a0: ; ldy #imm   [$a0] A0X0
    EAC_IMMDEPEND();cpu.YL = CPUReadByte();ALUSetNZ8(cpu.XL);break;

case 0x0a4: ; ldy dir    [$a4] A0X0
    EAC_DIRECT();cpu.YL = CPUReadByte();ALUSetNZ8(cpu.XL);break;

case 0x0ac: ; ldy abs    [$ac] A0X0
    EAC_ABSOLUTE();cpu.YL = CPUReadByte();ALUSetNZ8(cpu.XL);break;

case 0x0b4: ; ldy dir,Y  [$b4] A0X0
    EAC_DIRY();cpu.YL = CPUReadByte();ALUSetNZ8(cpu.XL);break;

case 0x0bc: ; ldy abs,Y  [$bc] A0X0
    EAC_ABSY();cpu.YL = CPUReadByte();ALUSetNZ8(cpu.XL);break;
...
case 0x2a0: ; ldy #imm   [$a0] A1X0
    EAC_IMMDEPEND();cpu.Y = CPUReadWord();ALUSetNZ16(cpu.X);break;

case 0x2a4: ; ldy dir    [$a4] A1X0
    EAC_DIRECT();cpu.Y = CPUReadWord();ALUSetNZ16(cpu.X);break;

case 0x2ac: ; ldy abs    [$ac] A1X0
    EAC_ABSOLUTE();cpu.Y = CPUReadWord();ALUSetNZ16(cpu.X);break;

case 0x2b4: ; ldy dir,Y  [$b4] A1X0
    EAC_DIRY();cpu.Y = CPUReadWord();ALUSetNZ16(cpu.X);break;

case 0x2bc: ; ldy abs,Y  [$bc] A1X0
    EAC_ABSY();cpu.Y = CPUReadWord();ALUSetNZ16(cpu.X);break;
...
case 0x086: ; stx dir    [$86] A0X0
    EAC_DIRECT();MB8 = cpu.XL;CPUWriteByte();break;

case 0x08e: ; stx abs    [$8e] A0X0
    EAC_ABSOLUTE();MB8 = cpu.XL;CPUWriteByte();break;

case 0x096: ; stx dir,X  [$96] A0X0
    EAC_DIRECTX();MB8 = cpu.XL;CPUWriteByte();break;
...
case 0x286: ; stx dir    [$86] A1X0
    EAC_DIRECT();MB16 = cpu.X;CPUWriteWord();break;

case 0x28e: ; stx abs    [$8e] A1X0
    EAC_ABSOLUTE();MB16 = cpu.X;CPUWriteWord();break;

case 0x296: ; stx dir,X  [$96] A1X0
    EAC_DIRECTX();MB16 = cpu.X;CPUWriteWord();break;
...
case 0x084: ; sty dir    [$84] A0X0
    EAC_DIRECT();MB8 = cpu.YL;CPUWriteByte();break;

case 0x08c: ; sty abs    [$8c] A0X0
    EAC_ABSOLUTE();MB8 = cpu.YL;CPUWriteByte();break;

case 0x094: ; sty dir,X  [$94] A0X0
    EAC_DIRECTX();MB8 = cpu.YL;CPUWriteByte();break;
...
case 0x284: ; sty dir    [$84] A1X0
    EAC_DIRECT();MB16 = cpu.Y;CPUWriteWord();break;

case 0x28c: ; sty abs    [$8c] A1X0
    EAC_ABSOLUTE();MB16 = cpu.Y;CPUWriteWord();break;

case 0x294: ; sty dir,X  [$94] A1X0
    EAC_DIRECTX();MB16 = cpu.Y;CPUWriteWord();break;
...
case 0x0e0: ; cpx #imm   [$e0] A0X0
    EAC_IMMDEPEND();ALUSbc8(cpu.XL,CPUReadByte(),1);break;

case 0x0e4: ; cpx dir    [$e4] A0X0
    EAC_DIRECT();ALUSbc8(cpu.XL,CPUReadByte(),1);break;

case 0x0ec: ; cpx abs    [$ec] A0X0
    EAC_ABSOLUTE();ALUSbc8(cpu.XL,CPUReadByte(),1);break;
...
case 0x2e0: ; cpx #imm   [$e0] A1X0
    EAC_IMMDEPEND();ALUSbc16(cpu.X,CPUReadWord(),1);break;

case 0x2e4: ; cpx dir    [$e4] A1X0
    EAC_DIRECT();ALUSbc16(cpu.X,CPUReadWord(),1);break;

case 0x2ec: ; cpx abs    [$ec] A1X0
    EAC_ABSOLUTE();ALUSbc16(cpu.X,CPUReadWord(),1);break;
...
case 0x0c0: ; cpy #imm   [$c0] A0X0
    EAC_IMMDEPEND();ALUSbc8(cpu.YL,CPUReadByte(),1);break;

case 0x0c4: ; cpy dir    [$c4] A0X0
    EAC_DIRECT();ALUSbc8(cpu.YL,CPUReadByte(),1);break;

case 0x0cc: ; cpy abs    [$cc] A0X0
    EAC_ABSOLUTE();ALUSbc8(cpu.YL,CPUReadByte(),1);break;
...
case 0x2c0: ; cpy #imm   [$c0] A1X0
    EAC_IMMDEPEND();ALUSbc16(cpu.Y,CPUReadWord(),1);break;

case 0x2c4: ; cpy dir    [$c4] A1X0
    EAC_DIRECT();ALUSbc16(cpu.Y,CPUReadWord(),1);break;

case 0x2cc: ; cpy abs    [$cc] A1X0
    EAC_ABSOLUTE();ALUSbc16(cpu.Y,CPUReadWord(),1);break;
...
case 0x0d6: ; dec dir,x  [$d6] A0X0
    EAC_DIRECTX();CPUReadByte();MB8--;CPUWriteByte();ALUSetNZ8(MB8);break;

case 0x0de: ; dec abs,x  [$de] A0X0
    EAC_ABSX();CPUReadByte();MB8--;CPUWriteByte();ALUSetNZ8(MB8);break;
...
case 0x2d6: ; dec dir,x  [$d6] A1X0
    EAC_DIRECTX();CPUReadWord();MB16--;CPUWriteWord();ALUSetNZ16(MB16);break;

case 0x2de: ; dec abs,x  [$de] A1X0
    EAC_ABSX();CPUReadWord();MB16--;CPUWriteWord();ALUSetNZ16(MB16);break;
...
case 0x2e6: ; inc dir    [$e6] A1X0
    EAC_DIRECT();CPUReadWord();MB16++;CPUWriteWord();ALUSetNZ(MB16);break;

case 0x2ee: ; inc abs    [$ee] A1X0
    EAC_ABSOLUTE();CPUReadWord();MB16++;CPUWriteWord();ALUSetNZ(MB16);break;

case 0x2f6: ; inc dir,x  [$f6] A1X0
    EAC_DIRECTX();CPUReadWord();MB16++;CPUWriteWord();ALUSetNZ(MB16);break;

case 0x2fe: ; inc abs,x  [$fe] A1X0
    EAC_ABSX();CPUReadWord();MB16++;CPUWriteWord();ALUSetNZ(MB16);break;
...
case 0x024: ; bit dir    [$24] A0X0
    EAC_DIRECT();ALUBitTest8(CPUReadByte(),cpu.AL);break;

case 0x02c: ; bit abs    [$2c] A0X0
    EAC_ABSOLUTE();ALUBitTest8(CPUReadByte(),cpu.AL);break;

case 0x034: ; bit dir,x  [$34] A0X0
    EAC_DIRECTX();ALUBitTest8(CPUReadByte(),cpu.AL);break;

case 0x03c: ; bit abs,x  [$3c] A0X0
    EAC_ABSX();ALUBitTest8(CPUReadByte(),cpu.AL);break;
...
case 0x224: ; bit dir    [$24] A1X0
    EAC_DIRECT();ALUBitTest16(CPUReadWord(),cpu.A);break;

case 0x22c: ; bit abs    [$2c] A1X0
    EAC_ABSOLUTE();ALUBitTest16(CPUReadWord(),cpu.A);break;

case 0x234: ; bit dir,x  [$34] A1X0
    EAC_DIRECTX();ALUBitTest16(CPUReadWord(),cpu.A);break;

case 0x23c: ; bit abs,x  [$3c] A1X0
    EAC_ABSX();ALUBitTest16(CPUReadWord(),cpu.A);break;
...
case 0x089: ; bit #imm8  [$89] A0X0
    EAC_IMM8();ALUSetZ8(CPUReadByte() & cpu.AL);break;

case 0x189: ; bit #imm8  [$89] A0X1
    EAC_IMM8();ALUSetZ8(CPUReadByte() & cpu.AL);break;

case 0x289: ; bit #imm8  [$89] A1X0
    EAC_IMM8();ALUSetZ16(CPUReadWord() & cpu.A);break;

case 0x389: ; bit #imm8  [$89] A1X1
    EAC_IMM8();ALUSetZ16(CPUReadWord() & cpu.A);break;

case 0x014: ; trb dir    [$14] A0X0
    EAC_DIRECT();CPUReadByte();ALUSetZ8(MB8 & cpu.AL);MB8 &= (cpu.AL ^ 0xFF);CPUWriteByte();break;

case 0x01c: ; trb abs    [$1c] A0X0
    EAC_ABSOLUTE();CPUReadByte();ALUSetZ8(MB8 & cpu.AL);MB8 &= (cpu.AL ^ 0xFF);CPUWriteByte();break;
...
case 0x214: ; trb dir    [$14] A1X0
    EAC_DIRECT();CPUReadWord();ALUSetZ16(MB16 & cpu.A);MB16 &= (cpu.A ^ 0xFFFF);CPUWriteWord();break;

case 0x21c: ; trb abs    [$1c] A1X0
    EAC_ABSOLUTE();CPUReadWord();ALUSetZ16(MB16 & cpu.A);MB16 &= (cpu.A ^ 0xFFFF);CPUWriteWord();break;
...
case 0x004: ; tsb dir    [$04] A0X0
    EAC_DIRECT();CPUReadByte();ALUSetZ8(MB8 & cpu.AL);MB8 |= cpu.AL;CPUWriteByte();break;

case 0x00c: ; tsb abs    [$0c] A0X0
    EAC_ABSOLUTE();CPUReadByte();ALUSetZ8(MB8 & cpu.AL);MB8 |= cpu.AL;CPUWriteByte();break;
...
case 0x204: ; tsb dir    [$04] A1X0
    EAC_DIRECT();CPUReadWord();ALUSetZ16(MB16 & cpu.A);MB16 |= cpu.A;CPUWriteWord();break;

case 0x20c: ; tsb abs    [$0c] A1X0
    EAC_ABSOLUTE();CPUReadWord();ALUSetZ16(MB16 & cpu.A);MB16 |= cpu.A;CPUWriteWord();break;
...
case 0x016: ; asl dir,x  [$16] A0X0
    EAC_DIRECTX();CPUReadByte();ALUAsl8(&MB8);CPUWriteByte();break;

case 0x01e: ; asl abs,x  [$1e] A0X0
    EAC_ABSX();CPUReadByte();ALUAsl8(&MB8);CPUWriteByte();break;
...
case 0x216: ; asl dir,x  [$16] A1X0
    EAC_DIRECTX();CPUReadWord();ALUAsl16(&MB16);CPUWriteWord();break;

case 0x21e: ; asl abs,x  [$1e] A1X0
    EAC_ABSX();CPUReadWord();ALUAsl16(&MB16);CPUWriteWord();break;
...
case 0x056: ; lsr dir,x  [$56] A0X0
    EAC_DIRECTX();CPUReadByte();ALULsr8(&MB8);CPUWriteByte();break;

case 0x05e: ; lsr abs,x  [$5e] A0X0
    EAC_ABSX();CPUReadByte();ALULsr8(&MB8);CPUWriteByte();break;
...
case 0x256: ; lsr dir,x  [$56] A1X0
    EAC_DIRECTX();CPUReadWord();ALULsr16(&MB16);CPUWriteWord();break;

case 0x25e: ; lsr abs,x  [$5e] A1X0
    EAC_ABSX();CPUReadWord();ALULsr16(&MB16);CPUWriteWord();break;
...
case 0x036: ; rol dir,x  [$36] A0X0
    EAC_DIRECTX();CPUReadByte();ALURol8(&MB8);CPUWriteByte();break;

case 0x03e: ; rol abs,x  [$3e] A0X0
    EAC_ABSX();CPUReadByte();ALURol8(&MB8);CPUWriteByte();break;
...
case 0x236: ; rol dir,x  [$36] A1X0
    EAC_DIRECTX();CPUReadWord();ALURol16(&MB16);CPUWriteWord();break;

case 0x23e: ; rol abs,x  [$3e] A1X0
    EAC_ABSX();CPUReadWord();ALURol16(&MB16);CPUWriteWord();break;
...
case 0x076: ; ror dir,x  [$76] A0X0
    EAC_DIRECTX();CPUReadByte();ALURor8(&MB8);CPUWriteByte();break;

case 0x07e: ; ror abs,x  [$7e] A0X0
    EAC_ABSX();CPUReadByte();ALURor8(&MB8);CPUWriteByte();break;
...
case 0x276: ; ror dir,x  [$76] A1X0
    EAC_DIRECTX();CPUReadWord();ALURor16(&MB16);CPUWriteWord();break;

case 0x27e: ; ror abs,x  [$7e] A1X0
    EAC_ABSX();CPUReadWord();ALURor16(&MB16);CPUWriteWord();break;
...
case 0x090: ; bcc rel8   [$90] A0X0
    EAC_REL8();if (cpu.P.C == 0) cpu.PC = MA;break;
...
case 0x0f0: ; beq rel8   [$f0] A0X0
    EAC_REL8();if (cpu.P.Z != 0) cpu.PC = MA;break;
...
case 0x030: ; bmi rel8   [$30] A0X0
    EAC_REL8();if (cpu.P.M != 0) cpu.PC = MA;break;
...
case 0x050: ; bvc rel8   [$50] A0X0
    EAC_REL8();if (cpu.P.V == 0) cpu.PC = MA;break;
...
case 0x04c: ; jmp abs    [$4c] A0X0
    EAC_ABSOLUTE();cpu.PC = (cpu.PC & 0xFF0000) | (MA & 0xFFFF);break;

case 0x06c: ; jmp (abs)  [$6c] A0X0
    EAC_ABSIND();cpu.PC = (cpu.PC & 0xFF0000) | (MA & 0xFFFF);break;

case 0x07c: ; jmp (abs,X) [$7c] A0X0
    EAC_INDEXINDABS();cpu.PC = (cpu.PC & 0xFF0000) | (MA & 0xFFFF);break;
...
case 0x022: ; jsl long   [$22] A0X0
    EAC_FAR();cpu.PC--;CPUPush8(cpu.PC >> 16);CPUPush16(cpu.PC & 0xFFFF);cpu.PC = MA;break;
...
case 0x020: ; jsr abs    [$20] A0X0
    EAC_ABSOLUTE();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (cpu.PC & 0xFF0000) | (MA & 0xFFFF);break;

case 0x0fc: ; jsr (abs,X) [$fc] A0X0
    EAC_INDEXINDABS();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (cpu.PC & 0xFF0000) | (MA & 0xFFFF);break;
...
case 0x040: ; rti        [$40] A0X0
    ALUExpandPS(CPUPop8());PC = CPUPop16();PC |= (CPUPop8() << 16);ALUUpdatePS();break;
...
case 0x000: ; brk        [$00] A0X0
    CPUPush8(cpu.PC >> 16);CPUPush16(cpu.PC+1);CPUPush8(ALUBuildPS());MA = 0xFFE6;CPUReadWord();PC = MB;break;
...
case 0x002: ; cop        [$02] A0X0
    CPUPush8(cpu.PC >> 16);CPUPush16(cpu.PC+1);CPUPush8(ALUBuildPS());MA = 0xFFF4;CPUReadWord();PC = MB;break;
...
case 0x0c2: ; rep #imm8  [$c2] A0X0
    EAC_IMM8();BUILDPS();ALUExpandPS(ALUBuildPS() & (CPUReadByte()^0xFF));ALUUpdatePS();break;
...
case 0x0e2: ; sep #imm8  [$e2] A0X0
    EAC_IMM8();BUILDPS();ALUExpandPS(ALUBuildPS() | CPUReadByte());ALUUpdatePS();break;
...
case 0x0f4: ; pea #imm16 [$f4] A0X0
    EAC_IMM16();CPUPush16(CPUReadWord());break;
...
case 0x062: ; per rel16  [$62] A0X0
    EAC_REL16();CPUPush16(MA & 0xFFFF);break;
...
case 0x068: ; pla        [$68] A0X0
    cpu.AL = CPUPop8();ALUSetNZ8(cpu.AL);break;
...
case 0x028: ; plp        [$28] A0X0
    MB8 = CPUPull8();ALUExpandPS(MB8);ALUUpdatePS();break;
...
case 0x0ab: ; plb        [$ab] A0X0
    cpu.DBR = CPUPull8();ALUSetNZ8(cpu.DBR);break;
...
case 0x02b: ; pld        [$2b] A0X0
    cpu.D = CPUPull16();ALUSetNZ16(cpu.D);break;
...
case 0x0aa: ; tax        [$aa] A0X0
    cpu.XL = cpu.AL;ALUSetNZ8(cpu.XL);break;
...
case 0x0a8: ; tay        [$a8] A0X0
    cpu.YL = cpu.AL;ALUSetNZ8(cpu.YL);break;
...
case 0x08a: ; txa        [$8a] A0X0
    cpu.AL = cpu.XL;ALUSetNZ8(cpu.AL);break;
...
case 0x098: ; tya        [$98] A0X0
    cpu.AL = cpu.YL;ALUSetNZ8(cpu.AL);break;
...
case 0x0eb: ; xba        [$eb] A0X0
    MB8 = cpu.AL;cpu.AL = cpu.AH;cpu.AH = MB8;ALUSetNZ8(cpu.AL);break;
