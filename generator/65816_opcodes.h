case 0x0a1: // lda (dir,X) [$a1] A0X0
    EAC_DIRECT_IDX_X_IND();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0a3: // lda stk,S  [$a3] A0X0
    EAC_STK_IDX_S();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0a5: // lda dir    [$a5] A0X0
    EAC_DIRECT();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0a7: // lda [dir]  [$a7] A0X0
    EAC_DIRECT_IND_FAR();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0a9: // lda #imma  [$a9] A0X0
    EAC_IMM_8();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0ad: // lda abs    [$ad] A0X0
    EAC_ABSOLUTE();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0af: // lda long   [$af] A0X0
    EAC_LONG();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b1: // lda (dir),Y [$b1] A0X0
    EAC_DIRECT_IND_IDX_Y();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b2: // lda (dir)  [$b2] A0X0
    EAC_DIRECT_IND();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b3: // lda (stk,S),Y [$b3] A0X0
    EAC_STK_IDX_S_IND_Y();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b5: // lda dir,x  [$b5] A0X0
    EAC_DIRECT_IDX_X();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b7: // lda [dir],y [$b7] A0X0
    EAC_DIRECT_IND_FAR_IDX_Y();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b9: // lda abs,y  [$b9] A0X0
    EAC_ABSOLUTE_IDX_Y();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0bd: // lda abs,x  [$bd] A0X0
    EAC_ABSOLUTE_IDX_X();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0bf: // lda long,x [$bf] A0X0
    EAC_LONG_IDX_X();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;
...
case 0x2a1: // lda (dir,X) [$a1] A1X0
    EAC_DIRECT_IDX_X_IND();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2a3: // lda stk,S  [$a3] A1X0
    EAC_STK_IDX_S();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2a5: // lda dir    [$a5] A1X0
    EAC_DIRECT();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2a7: // lda [dir]  [$a7] A1X0
    EAC_DIRECT_IND_FAR();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2a9: // lda #imma  [$a9] A1X0
    EAC_IMM_16();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2ad: // lda abs    [$ad] A1X0
    EAC_ABSOLUTE();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2af: // lda long   [$af] A1X0
    EAC_LONG();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b1: // lda (dir),Y [$b1] A1X0
    EAC_DIRECT_IND_IDX_Y();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b2: // lda (dir)  [$b2] A1X0
    EAC_DIRECT_IND();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b3: // lda (stk,S),Y [$b3] A1X0
    EAC_STK_IDX_S_IND_Y();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b5: // lda dir,x  [$b5] A1X0
    EAC_DIRECT_IDX_X();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b7: // lda [dir],y [$b7] A1X0
    EAC_DIRECT_IND_FAR_IDX_Y();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b9: // lda abs,y  [$b9] A1X0
    EAC_ABSOLUTE_IDX_Y();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2bd: // lda abs,x  [$bd] A1X0
    EAC_ABSOLUTE_IDX_X();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2bf: // lda long,x [$bf] A1X0
    EAC_LONG_IDX_X();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;
...
case 0x081: // sta (dir,X) [$81] A0X0
    EAC_DIRECT_IDX_X_IND();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x083: // sta stk,S  [$83] A0X0
    EAC_STK_IDX_S();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x085: // sta dir    [$85] A0X0
    EAC_DIRECT();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x087: // sta [dir]  [$87] A0X0
    EAC_DIRECT_IND_FAR();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x08d: // sta abs    [$8d] A0X0
    EAC_ABSOLUTE();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x08f: // sta long   [$8f] A0X0
    EAC_LONG();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x091: // sta (dir),Y [$91] A0X0
    EAC_DIRECT_IND_IDX_Y();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x092: // sta (dir)  [$92] A0X0
    EAC_DIRECT_IND();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x093: // sta (stk,S),Y [$93] A0X0
    EAC_STK_IDX_S_IND_Y();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x095: // sta dir,x  [$95] A0X0
    EAC_DIRECT_IDX_X();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x097: // sta [dir],y [$97] A0X0
    EAC_DIRECT_IND_FAR_IDX_Y();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x099: // sta abs,y  [$99] A0X0
    EAC_ABSOLUTE_IDX_Y();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x09d: // sta abs,x  [$9d] A0X0
    EAC_ABSOLUTE_IDX_X();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x09f: // sta long,x [$9f] A0X0
    EAC_LONG_IDX_X();MB8 = cpu.A.B.L;CPUWriteByte();break;
...
case 0x281: // sta (dir,X) [$81] A1X0
    EAC_DIRECT_IDX_X_IND();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x283: // sta stk,S  [$83] A1X0
    EAC_STK_IDX_S();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x285: // sta dir    [$85] A1X0
    EAC_DIRECT();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x287: // sta [dir]  [$87] A1X0
    EAC_DIRECT_IND_FAR();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x28d: // sta abs    [$8d] A1X0
    EAC_ABSOLUTE();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x28f: // sta long   [$8f] A1X0
    EAC_LONG();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x291: // sta (dir),Y [$91] A1X0
    EAC_DIRECT_IND_IDX_Y();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x292: // sta (dir)  [$92] A1X0
    EAC_DIRECT_IND();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x293: // sta (stk,S),Y [$93] A1X0
    EAC_STK_IDX_S_IND_Y();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x295: // sta dir,x  [$95] A1X0
    EAC_DIRECT_IDX_X();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x297: // sta [dir],y [$97] A1X0
    EAC_DIRECT_IND_FAR_IDX_Y();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x299: // sta abs,y  [$99] A1X0
    EAC_ABSOLUTE_IDX_Y();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x29d: // sta abs,x  [$9d] A1X0
    EAC_ABSOLUTE_IDX_X();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x29f: // sta long,x [$9f] A1X0
    EAC_LONG_IDX_X();MB16 = cpu.A.W;CPUWriteWord();break;
...
case 0x061: // adc (dir,X) [$61] A0X0
    EAC_DIRECT_IDX_X_IND();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x063: // adc stk,S  [$63] A0X0
    EAC_STK_IDX_S();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x065: // adc dir    [$65] A0X0
    EAC_DIRECT();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x067: // adc [dir]  [$67] A0X0
    EAC_DIRECT_IND_FAR();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x069: // adc #imma  [$69] A0X0
    EAC_IMM_8();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x06d: // adc abs    [$6d] A0X0
    EAC_ABSOLUTE();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x06f: // adc long   [$6f] A0X0
    EAC_LONG();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x071: // adc (dir),Y [$71] A0X0
    EAC_DIRECT_IND_IDX_Y();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x072: // adc (dir)  [$72] A0X0
    EAC_DIRECT_IND();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x073: // adc (stk,S),Y [$73] A0X0
    EAC_STK_IDX_S_IND_Y();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x075: // adc dir,x  [$75] A0X0
    EAC_DIRECT_IDX_X();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x077: // adc [dir],y [$77] A0X0
    EAC_DIRECT_IND_FAR_IDX_Y();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x079: // adc abs,y  [$79] A0X0
    EAC_ABSOLUTE_IDX_Y();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x07d: // adc abs,x  [$7d] A0X0
    EAC_ABSOLUTE_IDX_X();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x07f: // adc long,x [$7f] A0X0
    EAC_LONG_IDX_X();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;
...
case 0x261: // adc (dir,X) [$61] A1X0
    EAC_DIRECT_IDX_X_IND();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x263: // adc stk,S  [$63] A1X0
    EAC_STK_IDX_S();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x265: // adc dir    [$65] A1X0
    EAC_DIRECT();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x267: // adc [dir]  [$67] A1X0
    EAC_DIRECT_IND_FAR();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x269: // adc #imma  [$69] A1X0
    EAC_IMM_16();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x26d: // adc abs    [$6d] A1X0
    EAC_ABSOLUTE();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x26f: // adc long   [$6f] A1X0
    EAC_LONG();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x271: // adc (dir),Y [$71] A1X0
    EAC_DIRECT_IND_IDX_Y();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x272: // adc (dir)  [$72] A1X0
    EAC_DIRECT_IND();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x273: // adc (stk,S),Y [$73] A1X0
    EAC_STK_IDX_S_IND_Y();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x275: // adc dir,x  [$75] A1X0
    EAC_DIRECT_IDX_X();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x277: // adc [dir],y [$77] A1X0
    EAC_DIRECT_IND_FAR_IDX_Y();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x279: // adc abs,y  [$79] A1X0
    EAC_ABSOLUTE_IDX_Y();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x27d: // adc abs,x  [$7d] A1X0
    EAC_ABSOLUTE_IDX_X();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x27f: // adc long,x [$7f] A1X0
    EAC_LONG_IDX_X();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;
...
case 0x0e1: // sbc (dir,X) [$e1] A0X0
    EAC_DIRECT_IDX_X_IND();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0e3: // sbc stk,S  [$e3] A0X0
    EAC_STK_IDX_S();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0e5: // sbc dir    [$e5] A0X0
    EAC_DIRECT();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0e7: // sbc [dir]  [$e7] A0X0
    EAC_DIRECT_IND_FAR();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0e9: // sbc #imma  [$e9] A0X0
    EAC_IMM_8();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0ed: // sbc abs    [$ed] A0X0
    EAC_ABSOLUTE();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0ef: // sbc long   [$ef] A0X0
    EAC_LONG();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f1: // sbc (dir),Y [$f1] A0X0
    EAC_DIRECT_IND_IDX_Y();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f2: // sbc (dir)  [$f2] A0X0
    EAC_DIRECT_IND();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f3: // sbc (stk,S),Y [$f3] A0X0
    EAC_STK_IDX_S_IND_Y();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f5: // sbc dir,x  [$f5] A0X0
    EAC_DIRECT_IDX_X();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f7: // sbc [dir],y [$f7] A0X0
    EAC_DIRECT_IND_FAR_IDX_Y();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f9: // sbc abs,y  [$f9] A0X0
    EAC_ABSOLUTE_IDX_Y();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0fd: // sbc abs,x  [$fd] A0X0
    EAC_ABSOLUTE_IDX_X();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0ff: // sbc long,x [$ff] A0X0
    EAC_LONG_IDX_X();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;
...
case 0x2e1: // sbc (dir,X) [$e1] A1X0
    EAC_DIRECT_IDX_X_IND();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2e3: // sbc stk,S  [$e3] A1X0
    EAC_STK_IDX_S();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2e5: // sbc dir    [$e5] A1X0
    EAC_DIRECT();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2e7: // sbc [dir]  [$e7] A1X0
    EAC_DIRECT_IND_FAR();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2e9: // sbc #imma  [$e9] A1X0
    EAC_IMM_16();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2ed: // sbc abs    [$ed] A1X0
    EAC_ABSOLUTE();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2ef: // sbc long   [$ef] A1X0
    EAC_LONG();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f1: // sbc (dir),Y [$f1] A1X0
    EAC_DIRECT_IND_IDX_Y();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f2: // sbc (dir)  [$f2] A1X0
    EAC_DIRECT_IND();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f3: // sbc (stk,S),Y [$f3] A1X0
    EAC_STK_IDX_S_IND_Y();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f5: // sbc dir,x  [$f5] A1X0
    EAC_DIRECT_IDX_X();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f7: // sbc [dir],y [$f7] A1X0
    EAC_DIRECT_IND_FAR_IDX_Y();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f9: // sbc abs,y  [$f9] A1X0
    EAC_ABSOLUTE_IDX_Y();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2fd: // sbc abs,x  [$fd] A1X0
    EAC_ABSOLUTE_IDX_X();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2ff: // sbc long,x [$ff] A1X0
    EAC_LONG_IDX_X();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;
...
case 0x0c1: // cmp (dir,X) [$c1] A0X0
    EAC_DIRECT_IDX_X_IND();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0c3: // cmp stk,S  [$c3] A0X0
    EAC_STK_IDX_S();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0c5: // cmp dir    [$c5] A0X0
    EAC_DIRECT();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0c7: // cmp [dir]  [$c7] A0X0
    EAC_DIRECT_IND_FAR();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0c9: // cmp #imma  [$c9] A0X0
    EAC_IMM_8();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0cd: // cmp abs    [$cd] A0X0
    EAC_ABSOLUTE();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0cf: // cmp long   [$cf] A0X0
    EAC_LONG();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d1: // cmp (dir),Y [$d1] A0X0
    EAC_DIRECT_IND_IDX_Y();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d2: // cmp (dir)  [$d2] A0X0
    EAC_DIRECT_IND();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d3: // cmp (stk,S),Y [$d3] A0X0
    EAC_STK_IDX_S_IND_Y();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d5: // cmp dir,x  [$d5] A0X0
    EAC_DIRECT_IDX_X();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d7: // cmp [dir],y [$d7] A0X0
    EAC_DIRECT_IND_FAR_IDX_Y();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d9: // cmp abs,y  [$d9] A0X0
    EAC_ABSOLUTE_IDX_Y();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0dd: // cmp abs,x  [$dd] A0X0
    EAC_ABSOLUTE_IDX_X();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0df: // cmp long,x [$df] A0X0
    EAC_LONG_IDX_X();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;
...
case 0x2c1: // cmp (dir,X) [$c1] A1X0
    EAC_DIRECT_IDX_X_IND();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2c3: // cmp stk,S  [$c3] A1X0
    EAC_STK_IDX_S();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2c5: // cmp dir    [$c5] A1X0
    EAC_DIRECT();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2c7: // cmp [dir]  [$c7] A1X0
    EAC_DIRECT_IND_FAR();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2c9: // cmp #imma  [$c9] A1X0
    EAC_IMM_16();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2cd: // cmp abs    [$cd] A1X0
    EAC_ABSOLUTE();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2cf: // cmp long   [$cf] A1X0
    EAC_LONG();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d1: // cmp (dir),Y [$d1] A1X0
    EAC_DIRECT_IND_IDX_Y();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d2: // cmp (dir)  [$d2] A1X0
    EAC_DIRECT_IND();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d3: // cmp (stk,S),Y [$d3] A1X0
    EAC_STK_IDX_S_IND_Y();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d5: // cmp dir,x  [$d5] A1X0
    EAC_DIRECT_IDX_X();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d7: // cmp [dir],y [$d7] A1X0
    EAC_DIRECT_IND_FAR_IDX_Y();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d9: // cmp abs,y  [$d9] A1X0
    EAC_ABSOLUTE_IDX_Y();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2dd: // cmp abs,x  [$dd] A1X0
    EAC_ABSOLUTE_IDX_X();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2df: // cmp long,x [$df] A1X0
    EAC_LONG_IDX_X();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;
...
case 0x021: // and (dir,X) [$21] A0X0
    EAC_DIRECT_IDX_X_IND();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x023: // and stk,S  [$23] A0X0
    EAC_STK_IDX_S();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x025: // and dir    [$25] A0X0
    EAC_DIRECT();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x027: // and [dir]  [$27] A0X0
    EAC_DIRECT_IND_FAR();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x029: // and #imma  [$29] A0X0
    EAC_IMM_8();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x02d: // and abs    [$2d] A0X0
    EAC_ABSOLUTE();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x02f: // and long   [$2f] A0X0
    EAC_LONG();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x031: // and (dir),Y [$31] A0X0
    EAC_DIRECT_IND_IDX_Y();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x032: // and (dir)  [$32] A0X0
    EAC_DIRECT_IND();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x033: // and (stk,S),Y [$33] A0X0
    EAC_STK_IDX_S_IND_Y();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x035: // and dir,x  [$35] A0X0
    EAC_DIRECT_IDX_X();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x037: // and [dir],y [$37] A0X0
    EAC_DIRECT_IND_FAR_IDX_Y();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x039: // and abs,y  [$39] A0X0
    EAC_ABSOLUTE_IDX_Y();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x03d: // and abs,x  [$3d] A0X0
    EAC_ABSOLUTE_IDX_X();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x03f: // and long,x [$3f] A0X0
    EAC_LONG_IDX_X();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;
...
case 0x221: // and (dir,X) [$21] A1X0
    EAC_DIRECT_IDX_X_IND();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x223: // and stk,S  [$23] A1X0
    EAC_STK_IDX_S();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x225: // and dir    [$25] A1X0
    EAC_DIRECT();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x227: // and [dir]  [$27] A1X0
    EAC_DIRECT_IND_FAR();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x229: // and #imma  [$29] A1X0
    EAC_IMM_16();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x22d: // and abs    [$2d] A1X0
    EAC_ABSOLUTE();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x22f: // and long   [$2f] A1X0
    EAC_LONG();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x231: // and (dir),Y [$31] A1X0
    EAC_DIRECT_IND_IDX_Y();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x232: // and (dir)  [$32] A1X0
    EAC_DIRECT_IND();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x233: // and (stk,S),Y [$33] A1X0
    EAC_STK_IDX_S_IND_Y();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x235: // and dir,x  [$35] A1X0
    EAC_DIRECT_IDX_X();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x237: // and [dir],y [$37] A1X0
    EAC_DIRECT_IND_FAR_IDX_Y();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x239: // and abs,y  [$39] A1X0
    EAC_ABSOLUTE_IDX_Y();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x23d: // and abs,x  [$3d] A1X0
    EAC_ABSOLUTE_IDX_X();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x23f: // and long,x [$3f] A1X0
    EAC_LONG_IDX_X();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;
...
case 0x0a2: // ldx #immx  [$a2] A0X0
    EAC_IMM_8();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0a6: // ldx dir    [$a6] A0X0
    EAC_DIRECT();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0ae: // ldx abs    [$ae] A0X0
    EAC_ABSOLUTE();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0b6: // ldx dir,Y  [$b6] A0X0
    EAC_DIRECT_IDX_Y();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0be: // ldx abs,Y  [$be] A0X0
    EAC_ABSOLUTE_IDX_Y();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x1a2: // ldx #immx  [$a2] A0X1
    EAC_IMM_16();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;
...
case 0x2a2: // ldx #immx  [$a2] A1X0
    EAC_IMM_8();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2a6: // ldx dir    [$a6] A1X0
    EAC_DIRECT();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2ae: // ldx abs    [$ae] A1X0
    EAC_ABSOLUTE();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2b6: // ldx dir,Y  [$b6] A1X0
    EAC_DIRECT_IDX_Y();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2be: // ldx abs,Y  [$be] A1X0
    EAC_ABSOLUTE_IDX_Y();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x3a2: // ldx #immx  [$a2] A1X1
    EAC_IMM_16();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;
...
case 0x0a0: // ldy #immx  [$a0] A0X0
    EAC_IMM_8();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0a4: // ldy dir    [$a4] A0X0
    EAC_DIRECT();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0ac: // ldy abs    [$ac] A0X0
    EAC_ABSOLUTE();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0b4: // ldy dir,Y  [$b4] A0X0
    EAC_DIRECT_IDX_Y();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0bc: // ldy abs,Y  [$bc] A0X0
    EAC_ABSOLUTE_IDX_Y();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x1a0: // ldy #immx  [$a0] A0X1
    EAC_IMM_16();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;
...
case 0x2a0: // ldy #immx  [$a0] A1X0
    EAC_IMM_8();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2a4: // ldy dir    [$a4] A1X0
    EAC_DIRECT();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2ac: // ldy abs    [$ac] A1X0
    EAC_ABSOLUTE();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2b4: // ldy dir,Y  [$b4] A1X0
    EAC_DIRECT_IDX_Y();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2bc: // ldy abs,Y  [$bc] A1X0
    EAC_ABSOLUTE_IDX_Y();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x3a0: // ldy #immx  [$a0] A1X1
    EAC_IMM_16();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;
...
case 0x086: // stx dir    [$86] A0X0
    EAC_DIRECT();MB8 = cpu.X.B.L;CPUWriteByte();break;

case 0x08e: // stx abs    [$8e] A0X0
    EAC_ABSOLUTE();MB8 = cpu.X.B.L;CPUWriteByte();break;

case 0x096: // stx dir,X  [$96] A0X0
    EAC_DIRECT_IDX_X();MB8 = cpu.X.B.L;CPUWriteByte();break;
...
case 0x286: // stx dir    [$86] A1X0
    EAC_DIRECT();MB16 = cpu.X.W;CPUWriteWord();break;

case 0x28e: // stx abs    [$8e] A1X0
    EAC_ABSOLUTE();MB16 = cpu.X.W;CPUWriteWord();break;

case 0x296: // stx dir,X  [$96] A1X0
    EAC_DIRECT_IDX_X();MB16 = cpu.X.W;CPUWriteWord();break;
...
case 0x084: // sty dir    [$84] A0X0
    EAC_DIRECT();MB8 = cpu.Y.B.L;CPUWriteByte();break;

case 0x08c: // sty abs    [$8c] A0X0
    EAC_ABSOLUTE();MB8 = cpu.Y.B.L;CPUWriteByte();break;

case 0x094: // sty dir,X  [$94] A0X0
    EAC_DIRECT_IDX_X();MB8 = cpu.Y.B.L;CPUWriteByte();break;
...
case 0x284: // sty dir    [$84] A1X0
    EAC_DIRECT();MB16 = cpu.Y.W;CPUWriteWord();break;

case 0x28c: // sty abs    [$8c] A1X0
    EAC_ABSOLUTE();MB16 = cpu.Y.W;CPUWriteWord();break;

case 0x294: // sty dir,X  [$94] A1X0
    EAC_DIRECT_IDX_X();MB16 = cpu.Y.W;CPUWriteWord();break;
...
case 0x064: // stz dir    [$64] A0X0
    EAC_DIRECT();MB8 = 0;CPUWriteByte();break;

case 0x074: // stz dir,X  [$74] A0X0
    EAC_DIRECT_IDX_X();MB8 = 0;CPUWriteByte();break;

case 0x09c: // stz abs    [$9c] A0X0
    EAC_ABSOLUTE();MB8 = 0;CPUWriteByte();break;

case 0x09e: // stz abs,X  [$9e] A0X0
    EAC_ABSOLUTE_IDX_X();MB8 = 0;CPUWriteByte();break;
...
case 0x264: // stz dir    [$64] A1X0
    EAC_DIRECT();MB16 = 0;CPUWriteWord();break;

case 0x274: // stz dir,X  [$74] A1X0
    EAC_DIRECT_IDX_X();MB16 = 0;CPUWriteWord();break;

case 0x29c: // stz abs    [$9c] A1X0
    EAC_ABSOLUTE();MB16 = 0;CPUWriteWord();break;

case 0x29e: // stz abs,X  [$9e] A1X0
    EAC_ABSOLUTE_IDX_X();MB16 = 0;CPUWriteWord();break;
...
case 0x0e0: // cpx #immx  [$e0] A0X0
    EAC_IMM_8();ALUSbc8(cpu.X.B.L,CPUReadByte(),1);break;

case 0x0e4: // cpx dir    [$e4] A0X0
    EAC_DIRECT();ALUSbc8(cpu.X.B.L,CPUReadByte(),1);break;

case 0x0ec: // cpx abs    [$ec] A0X0
    EAC_ABSOLUTE();ALUSbc8(cpu.X.B.L,CPUReadByte(),1);break;

case 0x1e0: // cpx #immx  [$e0] A0X1
    EAC_IMM_16();ALUSbc8(cpu.X.B.L,CPUReadByte(),1);break;
...
case 0x2e0: // cpx #immx  [$e0] A1X0
    EAC_IMM_8();ALUSbc16(cpu.X.W,CPUReadWord(),1);break;

case 0x2e4: // cpx dir    [$e4] A1X0
    EAC_DIRECT();ALUSbc16(cpu.X.W,CPUReadWord(),1);break;

case 0x2ec: // cpx abs    [$ec] A1X0
    EAC_ABSOLUTE();ALUSbc16(cpu.X.W,CPUReadWord(),1);break;

case 0x3e0: // cpx #immx  [$e0] A1X1
    EAC_IMM_16();ALUSbc16(cpu.X.W,CPUReadWord(),1);break;
...
case 0x0c0: // cpy #immx  [$c0] A0X0
    EAC_IMM_8();ALUSbc8(cpu.Y.B.L,CPUReadByte(),1);break;

case 0x0c4: // cpy dir    [$c4] A0X0
    EAC_DIRECT();ALUSbc8(cpu.Y.B.L,CPUReadByte(),1);break;

case 0x0cc: // cpy abs    [$cc] A0X0
    EAC_ABSOLUTE();ALUSbc8(cpu.Y.B.L,CPUReadByte(),1);break;

case 0x1c0: // cpy #immx  [$c0] A0X1
    EAC_IMM_16();ALUSbc8(cpu.Y.B.L,CPUReadByte(),1);break;
...
case 0x2c0: // cpy #immx  [$c0] A1X0
    EAC_IMM_8();ALUSbc16(cpu.Y.W,CPUReadWord(),1);break;

case 0x2c4: // cpy dir    [$c4] A1X0
    EAC_DIRECT();ALUSbc16(cpu.Y.W,CPUReadWord(),1);break;

case 0x2cc: // cpy abs    [$cc] A1X0
    EAC_ABSOLUTE();ALUSbc16(cpu.Y.W,CPUReadWord(),1);break;

case 0x3c0: // cpy #immx  [$c0] A1X1
    EAC_IMM_16();ALUSbc16(cpu.Y.W,CPUReadWord(),1);break;
...
case 0x0c6: // dec dir    [$c6] A0X0
    EAC_DIRECT();CPUReadByte();MB8--;CPUWriteByte();ALUSetNZ8(MB8);break;

case 0x0ce: // dec abs    [$ce] A0X0
    EAC_ABSOLUTE();CPUReadByte();MB8--;CPUWriteByte();ALUSetNZ8(MB8);break;

case 0x0d6: // dec dir,x  [$d6] A0X0
    EAC_DIRECT_IDX_X();CPUReadByte();MB8--;CPUWriteByte();ALUSetNZ8(MB8);break;

case 0x0de: // dec abs,x  [$de] A0X0
    EAC_ABSOLUTE_IDX_X();CPUReadByte();MB8--;CPUWriteByte();ALUSetNZ8(MB8);break;
...
case 0x2c6: // dec dir    [$c6] A1X0
    EAC_DIRECT();CPUReadWord();MB16--;CPUWriteWord();ALUSetNZ16(MB16);break;

case 0x2ce: // dec abs    [$ce] A1X0
    EAC_ABSOLUTE();CPUReadWord();MB16--;CPUWriteWord();ALUSetNZ16(MB16);break;

case 0x2d6: // dec dir,x  [$d6] A1X0
    EAC_DIRECT_IDX_X();CPUReadWord();MB16--;CPUWriteWord();ALUSetNZ16(MB16);break;

case 0x2de: // dec abs,x  [$de] A1X0
    EAC_ABSOLUTE_IDX_X();CPUReadWord();MB16--;CPUWriteWord();ALUSetNZ16(MB16);break;
...
case 0x024: // bit dir    [$24] A0X0
    EAC_DIRECT();ALUBitTest8(CPUReadByte(),cpu.A.B.L);break;

case 0x02c: // bit abs    [$2c] A0X0
    EAC_ABSOLUTE();ALUBitTest8(CPUReadByte(),cpu.A.B.L);break;

case 0x034: // bit dir,x  [$34] A0X0
    EAC_DIRECT_IDX_X();ALUBitTest8(CPUReadByte(),cpu.A.B.L);break;

case 0x03c: // bit abs,x  [$3c] A0X0
    EAC_ABSOLUTE_IDX_X();ALUBitTest8(CPUReadByte(),cpu.A.B.L);break;
...
case 0x224: // bit dir    [$24] A1X0
    EAC_DIRECT();ALUBitTest16(CPUReadWord(),cpu.A.W);break;

case 0x22c: // bit abs    [$2c] A1X0
    EAC_ABSOLUTE();ALUBitTest16(CPUReadWord(),cpu.A.W);break;

case 0x234: // bit dir,x  [$34] A1X0
    EAC_DIRECT_IDX_X();ALUBitTest16(CPUReadWord(),cpu.A.W);break;

case 0x23c: // bit abs,x  [$3c] A1X0
    EAC_ABSOLUTE_IDX_X();ALUBitTest16(CPUReadWord(),cpu.A.W);break;
...
case 0x089: // bit #imm8  [$89] A0X0
    EAC_IMM_8();ALUSetZ8(CPUReadByte() & cpu.A.B.L);break;

case 0x189: // bit #imm8  [$89] A0X1
    EAC_IMM_8();ALUSetZ8(CPUReadByte() & cpu.A.B.L);break;

case 0x289: // bit #imm8  [$89] A1X0
    EAC_IMM_8();ALUSetZ16(CPUReadWord() & cpu.A.W);break;

case 0x389: // bit #imm8  [$89] A1X1
    EAC_IMM_8();ALUSetZ16(CPUReadWord() & cpu.A.W);break;

case 0x014: // trb dir    [$14] A0X0
    EAC_DIRECT();CPUReadByte();ALUSetZ8(MB8 & cpu.A.B.L);MB8 &= (cpu.A.B.L ^ 0xFF);CPUWriteByte();break;

case 0x01c: // trb abs    [$1c] A0X0
    EAC_ABSOLUTE();CPUReadByte();ALUSetZ8(MB8 & cpu.A.B.L);MB8 &= (cpu.A.B.L ^ 0xFF);CPUWriteByte();break;
...
case 0x214: // trb dir    [$14] A1X0
    EAC_DIRECT();CPUReadWord();ALUSetZ16(MB16 & cpu.A.W);MB16 &= (cpu.A.W ^ 0xFFFF);CPUWriteWord();break;

case 0x21c: // trb abs    [$1c] A1X0
    EAC_ABSOLUTE();CPUReadWord();ALUSetZ16(MB16 & cpu.A.W);MB16 &= (cpu.A.W ^ 0xFFFF);CPUWriteWord();break;
...
case 0x004: // tsb dir    [$04] A0X0
    EAC_DIRECT();CPUReadByte();ALUSetZ8(MB8 & cpu.A.B.L);MB8 |= cpu.A.B.L;CPUWriteByte();break;

case 0x00c: // tsb abs    [$0c] A0X0
    EAC_ABSOLUTE();CPUReadByte();ALUSetZ8(MB8 & cpu.A.B.L);MB8 |= cpu.A.B.L;CPUWriteByte();break;
...
case 0x204: // tsb dir    [$04] A1X0
    EAC_DIRECT();CPUReadWord();ALUSetZ16(MB16 & cpu.A.W);MB16 |= cpu.A.W;CPUWriteWord();break;

case 0x20c: // tsb abs    [$0c] A1X0
    EAC_ABSOLUTE();CPUReadWord();ALUSetZ16(MB16 & cpu.A.W);MB16 |= cpu.A.W;CPUWriteWord();break;
...
case 0x006: // asl dir    [$06] A0X0
    EAC_DIRECT();CPUReadByte();ALUAsl8(&MB8);CPUWriteByte();break;

case 0x00e: // asl abs    [$0e] A0X0
    EAC_ABSOLUTE();CPUReadByte();ALUAsl8(&MB8);CPUWriteByte();break;

case 0x016: // asl dir,x  [$16] A0X0
    EAC_DIRECT_IDX_X();CPUReadByte();ALUAsl8(&MB8);CPUWriteByte();break;

case 0x01e: // asl abs,x  [$1e] A0X0
    EAC_ABSOLUTE_IDX_X();CPUReadByte();ALUAsl8(&MB8);CPUWriteByte();break;
...
case 0x206: // asl dir    [$06] A1X0
    EAC_DIRECT();CPUReadWord();ALUAsl16(&MB16);CPUWriteWord();break;

case 0x20e: // asl abs    [$0e] A1X0
    EAC_ABSOLUTE();CPUReadWord();ALUAsl16(&MB16);CPUWriteWord();break;

case 0x216: // asl dir,x  [$16] A1X0
    EAC_DIRECT_IDX_X();CPUReadWord();ALUAsl16(&MB16);CPUWriteWord();break;

case 0x21e: // asl abs,x  [$1e] A1X0
    EAC_ABSOLUTE_IDX_X();CPUReadWord();ALUAsl16(&MB16);CPUWriteWord();break;
...
case 0x046: // lsr dir    [$46] A0X0
    EAC_DIRECT();CPUReadByte();ALULsr8(&MB8);CPUWriteByte();break;

case 0x04e: // lsr abs    [$4e] A0X0
    EAC_ABSOLUTE();CPUReadByte();ALULsr8(&MB8);CPUWriteByte();break;

case 0x056: // lsr dir,x  [$56] A0X0
    EAC_DIRECT_IDX_X();CPUReadByte();ALULsr8(&MB8);CPUWriteByte();break;

case 0x05e: // lsr abs,x  [$5e] A0X0
    EAC_ABSOLUTE_IDX_X();CPUReadByte();ALULsr8(&MB8);CPUWriteByte();break;
...
case 0x246: // lsr dir    [$46] A1X0
    EAC_DIRECT();CPUReadWord();ALULsr16(&MB16);CPUWriteWord();break;

case 0x24e: // lsr abs    [$4e] A1X0
    EAC_ABSOLUTE();CPUReadWord();ALULsr16(&MB16);CPUWriteWord();break;

case 0x256: // lsr dir,x  [$56] A1X0
    EAC_DIRECT_IDX_X();CPUReadWord();ALULsr16(&MB16);CPUWriteWord();break;

case 0x25e: // lsr abs,x  [$5e] A1X0
    EAC_ABSOLUTE_IDX_X();CPUReadWord();ALULsr16(&MB16);CPUWriteWord();break;
...
case 0x026: // rol dir    [$26] A0X0
    EAC_DIRECT();CPUReadByte();ALURol8(&MB8);CPUWriteByte();break;

case 0x02e: // rol abs    [$2e] A0X0
    EAC_ABSOLUTE();CPUReadByte();ALURol8(&MB8);CPUWriteByte();break;

case 0x036: // rol dir,x  [$36] A0X0
    EAC_DIRECT_IDX_X();CPUReadByte();ALURol8(&MB8);CPUWriteByte();break;

case 0x03e: // rol abs,x  [$3e] A0X0
    EAC_ABSOLUTE_IDX_X();CPUReadByte();ALURol8(&MB8);CPUWriteByte();break;
...
case 0x226: // rol dir    [$26] A1X0
    EAC_DIRECT();CPUReadWord();ALURol16(&MB16);CPUWriteWord();break;

case 0x22e: // rol abs    [$2e] A1X0
    EAC_ABSOLUTE();CPUReadWord();ALURol16(&MB16);CPUWriteWord();break;

case 0x236: // rol dir,x  [$36] A1X0
    EAC_DIRECT_IDX_X();CPUReadWord();ALURol16(&MB16);CPUWriteWord();break;

case 0x23e: // rol abs,x  [$3e] A1X0
    EAC_ABSOLUTE_IDX_X();CPUReadWord();ALURol16(&MB16);CPUWriteWord();break;
...
case 0x066: // ror dir    [$66] A0X0
    EAC_DIRECT();CPUReadByte();ALURor8(&MB8);CPUWriteByte();break;

case 0x06e: // ror abs    [$6e] A0X0
    EAC_ABSOLUTE();CPUReadByte();ALURor8(&MB8);CPUWriteByte();break;

case 0x076: // ror dir,x  [$76] A0X0
    EAC_DIRECT_IDX_X();CPUReadByte();ALURor8(&MB8);CPUWriteByte();break;

case 0x07e: // ror abs,x  [$7e] A0X0
    EAC_ABSOLUTE_IDX_X();CPUReadByte();ALURor8(&MB8);CPUWriteByte();break;
...
case 0x266: // ror dir    [$66] A1X0
    EAC_DIRECT();CPUReadWord();ALURor16(&MB16);CPUWriteWord();break;

case 0x26e: // ror abs    [$6e] A1X0
    EAC_ABSOLUTE();CPUReadWord();ALURor16(&MB16);CPUWriteWord();break;

case 0x276: // ror dir,x  [$76] A1X0
    EAC_DIRECT_IDX_X();CPUReadWord();ALURor16(&MB16);CPUWriteWord();break;

case 0x27e: // ror abs,x  [$7e] A1X0
    EAC_ABSOLUTE_IDX_X();CPUReadWord();ALURor16(&MB16);CPUWriteWord();break;
...
case 0x090: // bcc rel8   [$90] A0X0
    EAC_RELATIVE_8();if (cpu.P.C == 0) cpu.PC = MA;break;
...
case 0x0f0: // beq rel8   [$f0] A0X0
    EAC_RELATIVE_8();if (cpu.P.Z != 0) cpu.PC = MA;break;
...
case 0x030: // bmi rel8   [$30] A0X0
    EAC_RELATIVE_8();if (cpu.P.M != 0) cpu.PC = MA;break;
...
case 0x080: // bra rel8   [$80] A0X0
    EAC_RELATIVE_8();cpu.PC = MA;break;
...
case 0x050: // bvc rel8   [$50] A0X0
    EAC_RELATIVE_8();if (cpu.P.V == 0) cpu.PC = MA;break;
...
case 0x082: // brl rel16  [$82] A0X0
    EAC_RELATIVE_16();cpu.PC = MA;break;
...
case 0x04c: // jmp abs    [$4c] A0X0
    EAC_ABSOLUTE();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x06c: // jmp (jabs) [$6c] A0X0
    EAC_JABSOLUTE_IND();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x07c: // jmp (jabs,x) [$7c] A0X0
    EAC_JABSOLUTE_IDX_X_IND();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x14c: // jmp abs    [$4c] A0X1
    EAC_ABSOLUTE();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x16c: // jmp (jabs) [$6c] A0X1
    EAC_JABSOLUTE_IND();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x17c: // jmp (jabs,x) [$7c] A0X1
    EAC_JABSOLUTE_IDX_X_IND();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x24c: // jmp abs    [$4c] A1X0
    EAC_ABSOLUTE();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x26c: // jmp (jabs) [$6c] A1X0
    EAC_JABSOLUTE_IND();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x27c: // jmp (jabs,x) [$7c] A1X0
    EAC_JABSOLUTE_IDX_X_IND();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x34c: // jmp abs    [$4c] A1X1
    EAC_ABSOLUTE();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x36c: // jmp (jabs) [$6c] A1X1
    EAC_JABSOLUTE_IND();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x37c: // jmp (jabs,x) [$7c] A1X1
    EAC_JABSOLUTE_IDX_X_IND();cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;
...
case 0x0dc: // jmp [jabs] [$dc] A0X0
    EAC_JABSOLUTE_IND_FAR();cpu.PC = MA;break;

case 0x1dc: // jmp [jabs] [$dc] A0X1
    EAC_JABSOLUTE_IND_FAR();cpu.PC = MA;break;

case 0x2dc: // jmp [jabs] [$dc] A1X0
    EAC_JABSOLUTE_IND_FAR();cpu.PC = MA;break;

case 0x3dc: // jmp [jabs] [$dc] A1X1
    EAC_JABSOLUTE_IND_FAR();cpu.PC = MA;break;

case 0x022: // jsl long   [$22] A0X0
    EAC_LONG();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);CPUPush8(cpu.PC >> 16);cpu.PC = MA;break;
...
case 0x020: // jsr abs    [$20] A0X0
    EAC_ABSOLUTE();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x0fc: // jsr (jabs,x) [$fc] A0X0
    EAC_JABSOLUTE_IDX_X_IND();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x120: // jsr abs    [$20] A0X1
    EAC_ABSOLUTE();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x1fc: // jsr (jabs,x) [$fc] A0X1
    EAC_JABSOLUTE_IDX_X_IND();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x220: // jsr abs    [$20] A1X0
    EAC_ABSOLUTE();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x2fc: // jsr (jabs,x) [$fc] A1X0
    EAC_JABSOLUTE_IDX_X_IND();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x320: // jsr abs    [$20] A1X1
    EAC_ABSOLUTE();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;

case 0x3fc: // jsr (jabs,x) [$fc] A1X1
    EAC_JABSOLUTE_IDX_X_IND();cpu.PC--;CPUPush16(cpu.PC & 0xFFFF);cpu.PC = (MA & 0xFFFF) | (cpu.PC & 0xFF0000);break;
...
case 0x0c2: // rep #imm8  [$c2] A0X0
    EAC_IMM_8();ALUExpandPS(ALUBuildPS() & (CPUReadByte()^0xFF));ALUUpdatePS();break;
...
case 0x0e2: // sep #imm8  [$e2] A0X0
    EAC_IMM_8();ALUExpandPS(ALUBuildPS() | CPUReadByte());ALUUpdatePS();break;
...
case 0x0f4: // pea #imm16 [$f4] A0X0
    EAC_IMM_16();CPUPush16(CPUReadWord());break;
...
case 0x0d4: // pei dir    [$d4] A0X0
    EAC_DIRECT();CPUPush16(CPUReadWord());break;
...
case 0x062: // per rel16  [$62] A0X0
    EAC_RELATIVE_16();CPUPush16(MA & 0xFFFF);break;
