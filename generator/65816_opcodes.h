case 0x0a1: // lda (dir,X) [$a1] A0X0
    EAC_INDEXIND();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0a3: // lda stk,S  [$a3] A0X0
    EAC_STACKREL();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0a5: // lda dir    [$a5] A0X0
    EAC_DIRECT();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0a7: // lda [dir]  [$a7] A0X0
    EAC_DIRFARIND();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0a9: // lda #imm   [$a9] A0X0
    EAC_IMMDEPEND();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;
...
case 0x0b1: // lda (dir),Y [$b1] A0X0
    EAC_DIRINDY();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b2: // lda (dir)  [$b2] A0X0
    EAC_DIRIND();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b3: // lda (stk,S),Y [$b3] A0X0
    EAC_STACKRELINDX();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b5: // lda dir,x  [$b5] A0X0
    EAC_DIRECTX();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b7: // lda [dir],y [$b7] A0X0
    EAC_DIRFARINDY();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0b9: // lda abs,y  [$b9] A0X0
    EAC_ABSOLUTEY();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0bd: // lda abs,x  [$bd] A0X0
    EAC_ABSOLUTEX();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x0bf: // lda long,x [$bf] A0X0
    EAC_LONGX();cpu.A.B.L = CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;
...
case 0x2a1: // lda (dir,X) [$a1] A1X0
    EAC_INDEXIND();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2a3: // lda stk,S  [$a3] A1X0
    EAC_STACKREL();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2a5: // lda dir    [$a5] A1X0
    EAC_DIRECT();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2a7: // lda [dir]  [$a7] A1X0
    EAC_DIRFARIND();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2a9: // lda #imm   [$a9] A1X0
    EAC_IMMDEPEND();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;
...
case 0x2b1: // lda (dir),Y [$b1] A1X0
    EAC_DIRINDY();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b2: // lda (dir)  [$b2] A1X0
    EAC_DIRIND();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b3: // lda (stk,S),Y [$b3] A1X0
    EAC_STACKRELINDX();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b5: // lda dir,x  [$b5] A1X0
    EAC_DIRECTX();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b7: // lda [dir],y [$b7] A1X0
    EAC_DIRFARINDY();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2b9: // lda abs,y  [$b9] A1X0
    EAC_ABSOLUTEY();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2bd: // lda abs,x  [$bd] A1X0
    EAC_ABSOLUTEX();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x2bf: // lda long,x [$bf] A1X0
    EAC_LONGX();cpu.A.W = CPUReadWord();ALUSetNZ16(cpu.A.W);break;
...
case 0x081: // sta (dir,X) [$81] A0X0
    EAC_INDEXIND();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x083: // sta stk,S  [$83] A0X0
    EAC_STACKREL();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x085: // sta dir    [$85] A0X0
    EAC_DIRECT();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x087: // sta [dir]  [$87] A0X0
    EAC_DIRFARIND();MB8 = cpu.A.B.L;CPUWriteByte();break;
...
case 0x091: // sta (dir),Y [$91] A0X0
    EAC_DIRINDY();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x092: // sta (dir)  [$92] A0X0
    EAC_DIRIND();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x093: // sta (stk,S),Y [$93] A0X0
    EAC_STACKRELINDX();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x095: // sta dir,x  [$95] A0X0
    EAC_DIRECTX();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x097: // sta [dir],y [$97] A0X0
    EAC_DIRFARINDY();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x099: // sta abs,y  [$99] A0X0
    EAC_ABSOLUTEY();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x09d: // sta abs,x  [$9d] A0X0
    EAC_ABSOLUTEX();MB8 = cpu.A.B.L;CPUWriteByte();break;

case 0x09f: // sta long,x [$9f] A0X0
    EAC_LONGX();MB8 = cpu.A.B.L;CPUWriteByte();break;
...
case 0x281: // sta (dir,X) [$81] A1X0
    EAC_INDEXIND();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x283: // sta stk,S  [$83] A1X0
    EAC_STACKREL();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x285: // sta dir    [$85] A1X0
    EAC_DIRECT();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x287: // sta [dir]  [$87] A1X0
    EAC_DIRFARIND();MB16 = cpu.A.W;CPUWriteWord();break;
...
case 0x291: // sta (dir),Y [$91] A1X0
    EAC_DIRINDY();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x292: // sta (dir)  [$92] A1X0
    EAC_DIRIND();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x293: // sta (stk,S),Y [$93] A1X0
    EAC_STACKRELINDX();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x295: // sta dir,x  [$95] A1X0
    EAC_DIRECTX();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x297: // sta [dir],y [$97] A1X0
    EAC_DIRFARINDY();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x299: // sta abs,y  [$99] A1X0
    EAC_ABSOLUTEY();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x29d: // sta abs,x  [$9d] A1X0
    EAC_ABSOLUTEX();MB16 = cpu.A.W;CPUWriteWord();break;

case 0x29f: // sta long,x [$9f] A1X0
    EAC_LONGX();MB16 = cpu.A.W;CPUWriteWord();break;
...
case 0x061: // adc (dir,X) [$61] A0X0
    EAC_INDEXIND();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x063: // adc stk,S  [$63] A0X0
    EAC_STACKREL();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x065: // adc dir    [$65] A0X0
    EAC_DIRECT();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x067: // adc [dir]  [$67] A0X0
    EAC_DIRFARIND();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x069: // adc #imm   [$69] A0X0
    EAC_IMMDEPEND();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;
...
case 0x071: // adc (dir),Y [$71] A0X0
    EAC_DIRINDY();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x072: // adc (dir)  [$72] A0X0
    EAC_DIRIND();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x073: // adc (stk,S),Y [$73] A0X0
    EAC_STACKRELINDX();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x075: // adc dir,x  [$75] A0X0
    EAC_DIRECTX();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x077: // adc [dir],y [$77] A0X0
    EAC_DIRFARINDY();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x079: // adc abs,y  [$79] A0X0
    EAC_ABSOLUTEY();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x07d: // adc abs,x  [$7d] A0X0
    EAC_ABSOLUTEX();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;

case 0x07f: // adc long,x [$7f] A0X0
    EAC_LONGX();cpu.A.B.L = ALUAdc8(cpu.A.B.L,CPUReadByte());break;
...
case 0x261: // adc (dir,X) [$61] A1X0
    EAC_INDEXIND();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x263: // adc stk,S  [$63] A1X0
    EAC_STACKREL();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x265: // adc dir    [$65] A1X0
    EAC_DIRECT();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x267: // adc [dir]  [$67] A1X0
    EAC_DIRFARIND();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x269: // adc #imm   [$69] A1X0
    EAC_IMMDEPEND();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;
...
case 0x271: // adc (dir),Y [$71] A1X0
    EAC_DIRINDY();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x272: // adc (dir)  [$72] A1X0
    EAC_DIRIND();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x273: // adc (stk,S),Y [$73] A1X0
    EAC_STACKRELINDX();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x275: // adc dir,x  [$75] A1X0
    EAC_DIRECTX();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x277: // adc [dir],y [$77] A1X0
    EAC_DIRFARINDY();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x279: // adc abs,y  [$79] A1X0
    EAC_ABSOLUTEY();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x27d: // adc abs,x  [$7d] A1X0
    EAC_ABSOLUTEX();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;

case 0x27f: // adc long,x [$7f] A1X0
    EAC_LONGX();cpu.A.W = ALUAdc16(cpu.A.W,CPUReadWord());break;
...
case 0x0e1: // sbc (dir,X) [$e1] A0X0
    EAC_INDEXIND();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0e3: // sbc stk,S  [$e3] A0X0
    EAC_STACKREL();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0e5: // sbc dir    [$e5] A0X0
    EAC_DIRECT();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0e7: // sbc [dir]  [$e7] A0X0
    EAC_DIRFARIND();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0e9: // sbc #imm   [$e9] A0X0
    EAC_IMMDEPEND();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;
...
case 0x0f1: // sbc (dir),Y [$f1] A0X0
    EAC_DIRINDY();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f2: // sbc (dir)  [$f2] A0X0
    EAC_DIRIND();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f3: // sbc (stk,S),Y [$f3] A0X0
    EAC_STACKRELINDX();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f5: // sbc dir,x  [$f5] A0X0
    EAC_DIRECTX();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f7: // sbc [dir],y [$f7] A0X0
    EAC_DIRFARINDY();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0f9: // sbc abs,y  [$f9] A0X0
    EAC_ABSOLUTEY();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0fd: // sbc abs,x  [$fd] A0X0
    EAC_ABSOLUTEX();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;

case 0x0ff: // sbc long,x [$ff] A0X0
    EAC_LONGX();cpu.A.B.L = ALUSbc8(cpu.A.B.L,CPUReadByte(),0);break;
...
case 0x2e1: // sbc (dir,X) [$e1] A1X0
    EAC_INDEXIND();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2e3: // sbc stk,S  [$e3] A1X0
    EAC_STACKREL();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2e5: // sbc dir    [$e5] A1X0
    EAC_DIRECT();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2e7: // sbc [dir]  [$e7] A1X0
    EAC_DIRFARIND();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2e9: // sbc #imm   [$e9] A1X0
    EAC_IMMDEPEND();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;
...
case 0x2f1: // sbc (dir),Y [$f1] A1X0
    EAC_DIRINDY();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f2: // sbc (dir)  [$f2] A1X0
    EAC_DIRIND();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f3: // sbc (stk,S),Y [$f3] A1X0
    EAC_STACKRELINDX();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f5: // sbc dir,x  [$f5] A1X0
    EAC_DIRECTX();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f7: // sbc [dir],y [$f7] A1X0
    EAC_DIRFARINDY();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2f9: // sbc abs,y  [$f9] A1X0
    EAC_ABSOLUTEY();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2fd: // sbc abs,x  [$fd] A1X0
    EAC_ABSOLUTEX();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;

case 0x2ff: // sbc long,x [$ff] A1X0
    EAC_LONGX();cpu.A.W = ALUSbc16(cpu.A.W,CPUReadWord(),0);break;
...
case 0x0c1: // cmp (dir,X) [$c1] A0X0
    EAC_INDEXIND();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0c3: // cmp stk,S  [$c3] A0X0
    EAC_STACKREL();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0c5: // cmp dir    [$c5] A0X0
    EAC_DIRECT();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0c7: // cmp [dir]  [$c7] A0X0
    EAC_DIRFARIND();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0c9: // cmp #imm   [$c9] A0X0
    EAC_IMMDEPEND();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;
...
case 0x0d1: // cmp (dir),Y [$d1] A0X0
    EAC_DIRINDY();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d2: // cmp (dir)  [$d2] A0X0
    EAC_DIRIND();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d3: // cmp (stk,S),Y [$d3] A0X0
    EAC_STACKRELINDX();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d5: // cmp dir,x  [$d5] A0X0
    EAC_DIRECTX();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d7: // cmp [dir],y [$d7] A0X0
    EAC_DIRFARINDY();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0d9: // cmp abs,y  [$d9] A0X0
    EAC_ABSOLUTEY();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0dd: // cmp abs,x  [$dd] A0X0
    EAC_ABSOLUTEX();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;

case 0x0df: // cmp long,x [$df] A0X0
    EAC_LONGX();ALUSbc8(cpu.A.B.L,CPUReadByte(),1);break;
...
case 0x2c1: // cmp (dir,X) [$c1] A1X0
    EAC_INDEXIND();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2c3: // cmp stk,S  [$c3] A1X0
    EAC_STACKREL();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2c5: // cmp dir    [$c5] A1X0
    EAC_DIRECT();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2c7: // cmp [dir]  [$c7] A1X0
    EAC_DIRFARIND();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2c9: // cmp #imm   [$c9] A1X0
    EAC_IMMDEPEND();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;
...
case 0x2d1: // cmp (dir),Y [$d1] A1X0
    EAC_DIRINDY();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d2: // cmp (dir)  [$d2] A1X0
    EAC_DIRIND();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d3: // cmp (stk,S),Y [$d3] A1X0
    EAC_STACKRELINDX();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d5: // cmp dir,x  [$d5] A1X0
    EAC_DIRECTX();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d7: // cmp [dir],y [$d7] A1X0
    EAC_DIRFARINDY();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2d9: // cmp abs,y  [$d9] A1X0
    EAC_ABSOLUTEY();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2dd: // cmp abs,x  [$dd] A1X0
    EAC_ABSOLUTEX();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;

case 0x2df: // cmp long,x [$df] A1X0
    EAC_LONGX();ALUSbc16(cpu.A.W,CPUReadWord(),1);break;
...
case 0x021: // and (dir,X) [$21] A0X0
    EAC_INDEXIND();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x023: // and stk,S  [$23] A0X0
    EAC_STACKREL();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x025: // and dir    [$25] A0X0
    EAC_DIRECT();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x027: // and [dir]  [$27] A0X0
    EAC_DIRFARIND();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x029: // and #imm   [$29] A0X0
    EAC_IMMDEPEND();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;
...
case 0x031: // and (dir),Y [$31] A0X0
    EAC_DIRINDY();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x032: // and (dir)  [$32] A0X0
    EAC_DIRIND();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x033: // and (stk,S),Y [$33] A0X0
    EAC_STACKRELINDX();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x035: // and dir,x  [$35] A0X0
    EAC_DIRECTX();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x037: // and [dir],y [$37] A0X0
    EAC_DIRFARINDY();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x039: // and abs,y  [$39] A0X0
    EAC_ABSOLUTEY();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x03d: // and abs,x  [$3d] A0X0
    EAC_ABSOLUTEX();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;

case 0x03f: // and long,x [$3f] A0X0
    EAC_LONGX();cpu.A.B.L = cpu.A.B.L & CPUReadByte();ALUSetNZ8(cpu.A.B.L);break;
...
case 0x221: // and (dir,X) [$21] A1X0
    EAC_INDEXIND();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x223: // and stk,S  [$23] A1X0
    EAC_STACKREL();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x225: // and dir    [$25] A1X0
    EAC_DIRECT();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x227: // and [dir]  [$27] A1X0
    EAC_DIRFARIND();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x229: // and #imm   [$29] A1X0
    EAC_IMMDEPEND();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;
...
case 0x231: // and (dir),Y [$31] A1X0
    EAC_DIRINDY();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x232: // and (dir)  [$32] A1X0
    EAC_DIRIND();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x233: // and (stk,S),Y [$33] A1X0
    EAC_STACKRELINDX();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x235: // and dir,x  [$35] A1X0
    EAC_DIRECTX();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x237: // and [dir],y [$37] A1X0
    EAC_DIRFARINDY();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x239: // and abs,y  [$39] A1X0
    EAC_ABSOLUTEY();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x23d: // and abs,x  [$3d] A1X0
    EAC_ABSOLUTEX();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;

case 0x23f: // and long,x [$3f] A1X0
    EAC_LONGX();cpu.A.W = cpu.A.W & CPUReadWord();ALUSetNZ16(cpu.A.W);break;
...
case 0x0a2: // ldx #imm   [$a2] A0X0
    EAC_IMMDEPEND();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;
...
case 0x0b6: // ldx dir,Y  [$b6] A0X0
    EAC_DIRECTY();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0be: // ldx abs,Y  [$be] A0X0
    EAC_ABSOLUTEY();cpu.X.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;
...
case 0x2a2: // ldx #imm   [$a2] A1X0
    EAC_IMMDEPEND();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;
...
case 0x2b6: // ldx dir,Y  [$b6] A1X0
    EAC_DIRECTY();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2be: // ldx abs,Y  [$be] A1X0
    EAC_ABSOLUTEY();cpu.X.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;
...
case 0x0a0: // ldy #imm   [$a0] A0X0
    EAC_IMMDEPEND();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;
...
case 0x0b4: // ldy dir,Y  [$b4] A0X0
    EAC_DIRECTY();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;

case 0x0bc: // ldy abs,Y  [$bc] A0X0
    EAC_ABSOLUTEY();cpu.Y.B.L = CPUReadByte();ALUSetNZ8(cpu.X.B.L);break;
...
case 0x2a0: // ldy #imm   [$a0] A1X0
    EAC_IMMDEPEND();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;
...
case 0x2b4: // ldy dir,Y  [$b4] A1X0
    EAC_DIRECTY();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;

case 0x2bc: // ldy abs,Y  [$bc] A1X0
    EAC_ABSOLUTEY();cpu.Y.W = CPUReadWord();ALUSetNZ16(cpu.X.W);break;
...
case 0x096: // stx dir,X  [$96] A0X0
    EAC_DIRECTX();MB8 = cpu.X.B.L;CPUWriteByte();break;
...
case 0x296: // stx dir,X  [$96] A1X0
    EAC_DIRECTX();MB16 = cpu.X.W;CPUWriteWord();break;
...
case 0x094: // sty dir,X  [$94] A0X0
    EAC_DIRECTX();MB8 = cpu.Y.B.L;CPUWriteByte();break;
...
case 0x294: // sty dir,X  [$94] A1X0
    EAC_DIRECTX();MB16 = cpu.Y.W;CPUWriteWord();break;
...
case 0x09e: // stz abs,X  [$9e] A0X0
    EAC_ABSOLUTEX();MB8 = 0;CPUWriteByte();break;
...
case 0x29e: // stz abs,X  [$9e] A1X0
    EAC_ABSOLUTEX();MB16 = 0;CPUWriteWord();break;
...
case 0x0e0: // cpx #imm   [$e0] A0X0
    EAC_IMMDEPEND();ALUSbc8(cpu.X.B.L,CPUReadByte(),1);break;
...
case 0x2e0: // cpx #imm   [$e0] A1X0
    EAC_IMMDEPEND();ALUSbc16(cpu.X.W,CPUReadWord(),1);break;
...
case 0x0c0: // cpy #imm   [$c0] A0X0
    EAC_IMMDEPEND();ALUSbc8(cpu.Y.B.L,CPUReadByte(),1);break;
...
case 0x2c0: // cpy #imm   [$c0] A1X0
    EAC_IMMDEPEND();ALUSbc16(cpu.Y.W,CPUReadWord(),1);break;
...
case 0x0de: // dec abs,x  [$de] A0X0
    EAC_ABSOLUTEX();CPUReadByte();MB8--;CPUWriteByte();ALUSetNZ8(MB8);break;
...
case 0x2de: // dec abs,x  [$de] A1X0
    EAC_ABSOLUTEX();CPUReadWord();MB16--;CPUWriteWord();ALUSetNZ16(MB16);break;
...
case 0x034: // bit dir,x  [$34] A0X0
    EAC_DIRECTX();ALUBitTest8(CPUReadByte(),cpu.A.B.L);break;

case 0x03c: // bit abs,x  [$3c] A0X0
    EAC_ABSOLUTEX();ALUBitTest8(CPUReadByte(),cpu.A.B.L);break;
...
case 0x234: // bit dir,x  [$34] A1X0
    EAC_DIRECTX();ALUBitTest16(CPUReadWord(),cpu.A.W);break;

case 0x23c: // bit abs,x  [$3c] A1X0
    EAC_ABSOLUTEX();ALUBitTest16(CPUReadWord(),cpu.A.W);break;
...
case 0x089: // bit #imm8  [$89] A0X0
    EAC_IMM8();ALUSetZ8(CPUReadByte() & cpu.A.B.L);break;

case 0x189: // bit #imm8  [$89] A0X1
    EAC_IMM8();ALUSetZ8(CPUReadByte() & cpu.A.B.L);break;

case 0x289: // bit #imm8  [$89] A1X0
    EAC_IMM8();ALUSetZ16(CPUReadWord() & cpu.A.W);break;
...
case 0x01e: // asl abs,x  [$1e] A0X0
    EAC_ABSOLUTEX();CPUReadByte();ALUAsl8(&MB8);CPUWriteByte();break;
...
case 0x21e: // asl abs,x  [$1e] A1X0
    EAC_ABSOLUTEX();CPUReadWord();ALUAsl16(&MB16);CPUWriteWord();break;
...
case 0x05e: // lsr abs,x  [$5e] A0X0
    EAC_ABSOLUTEX();CPUReadByte();ALULsr8(&MB8);CPUWriteByte();break;
...
case 0x25e: // lsr abs,x  [$5e] A1X0
    EAC_ABSOLUTEX();CPUReadWord();ALULsr16(&MB16);CPUWriteWord();break;
...
case 0x03e: // rol abs,x  [$3e] A0X0
    EAC_ABSOLUTEX();CPUReadByte();ALURol8(&MB8);CPUWriteByte();break;
...
case 0x23e: // rol abs,x  [$3e] A1X0
    EAC_ABSOLUTEX();CPUReadWord();ALURol16(&MB16);CPUWriteWord();break;
...
case 0x07e: // ror abs,x  [$7e] A0X0
    EAC_ABSOLUTEX();CPUReadByte();ALURor8(&MB8);CPUWriteByte();break;
...
case 0x27e: // ror abs,x  [$7e] A1X0
    EAC_ABSOLUTEX();CPUReadWord();ALURor16(&MB16);CPUWriteWord();break;
...
case 0x0c2: // rep #imm8  [$c2] A0X0
    EAC_IMM8();ALUExpandPS(ALUBuildPS() & (CPUReadByte()^0xFF));ALUUpdatePS();break;
...
case 0x0e2: // sep #imm8  [$e2] A0X0
    EAC_IMM8();ALUExpandPS(ALUBuildPS() | CPUReadByte());ALUUpdatePS();break;
